...
method_list = c("rpart", "rpart2","C5.0Tree","ctree","ctree2")
...
col_cost = 'cost_driving_ccharge' # 'cost_driving_fuel' # dur_pt_access cost_driving_ccharge
num_points = 100
