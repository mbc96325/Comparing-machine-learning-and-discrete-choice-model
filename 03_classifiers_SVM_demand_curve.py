...
if __name__ == '__main__':
    ...
    #==================Model
    max_iter = 500
    models = {'LinearSVC': LinearSVC(max_iter=max_iter),
              'SVC_poly': SVC(kernel='poly', max_iter=max_iter,probability=True),
              'SVC_rbf': SVC(kernel='rbf', max_iter=max_iter,probability=True),
              'SVC_sig': SVC(kernel='sigmoid', max_iter=max_iter,probability=True),
              'SVC_linear': SVC(kernel='linear', max_iter=max_iter,probability=True)}
    #==========================
    Estimator_name = 'SVM_python'
