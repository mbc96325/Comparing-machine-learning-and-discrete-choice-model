        ...
        for name in Model_dict:
            try:
                ...
                for point_value in all_points:
                    ...
                    if name in ['RidgeClassifier','PassiveAggressiveClassifier','SGDClassifier','SGD_sqhinge']:
...
if __name__ == '__main__':
    ...
    ################Model
    max_iter = 200
    models = {'LogisticRegression_l1': LogisticRegression(penalty='l1', max_iter=80),
              'LogisticRegression_l2': LogisticRegression(penalty='l2', max_iter=80, solver  = 'lbfgs'),
              'RidgeClassifier': RidgeClassifier(max_iter  = max_iter),
              'PassiveAggressiveClassifier': PassiveAggressiveClassifier(max_iter  = max_iter),
              'SGDClassifier': SGDClassifier(max_iter  = max_iter),
              'SGD_log': SGDClassifier(loss  = 'log', max_iter  = max_iter),
              'SGD_sqhinge': SGDClassifier(loss  = 'squared_hinge', max_iter  = max_iter),
              'SGD_mdhuber': SGDClassifier(loss  = 'modified_huber', max_iter  = max_iter)}
    ########################
    Estimator_name = 'GenLinear_python'
