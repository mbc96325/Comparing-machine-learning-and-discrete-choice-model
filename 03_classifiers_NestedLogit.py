...
def model_run(raw_data, output_file_path, cv, Re_run, computer_info, model_name, n_jobs, Dependent_var, DATASET):
    ...
    for train_index, test_index in kf.split(x_train_nn_all):
        ...
        biogeme.modelName = "NL_classifier"
        ...
        acc = predict_NL(beta, biogeme_file, data_test, mode_list, Dependent_var)
        print('accuracy:', acc)
        accuracy.append(acc)
    ...
    for DATASET in DATASET_list:
        for Dependent_var in Dependent_var_list:
            ...
            for sample_size in sample_size_list:
                ...
                model_run(data, output_file_path, 5, Re_run, computer_info, Estimator_name, n_jobs, Dependent_var, DATASET)
