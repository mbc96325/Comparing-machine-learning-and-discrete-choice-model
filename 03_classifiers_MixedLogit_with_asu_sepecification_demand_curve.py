...
def model_run(raw_data, data_test_raw, col_cost, num_points, MODE_WANT, output_file_path, cv, Re_run, computer_info,
              model_name, n_jobs, Dependent_var, Only_prob_est):
...
if __name__ == '__main__':
    ...
    Estimator_name = 'MixL_biogeme_ASUSpec'
