...
if __name__ == '__main__':
    ...
    models = {'LinearSVC': LinearSVC(max_iter=max_iter),
              'SVC_poly': SVC(kernel='poly', max_iter=max_iter),
              'SVC_rbf': SVC(kernel='rbf', max_iter=max_iter),
              'SVC_sig': SVC(kernel='sigmoid', max_iter=max_iter),
              'SVC_linear': SVC(kernel='linear', max_iter=max_iter)}
    #==========================
