...
from sklearn.gaussian_process.kernels import RBF, ConstantKernel,ExpSineSquared, DotProduct,Matern
...
if __name__ == '__main__':
    ...
    # Parameters:
    #=================Model
    models = { 'GP_ConstantKernel': GaussianProcessClassifier(kernel  = ConstantKernel(), multi_class  ='one_vs_rest', n_jobs = 1),
               'GP_DotProduct': GaussianProcessClassifier(kernel  = DotProduct(), multi_class  ='one_vs_rest', n_jobs = 1),
               'GP_Matern': GaussianProcessClassifier(kernel  = Matern(), multi_class  ='one_vs_rest', n_jobs = 1)}

    #====================
    Estimator_name = 'GP_python'

    computer_info = 'I9-9900K'
    sample_size_list = ['1k'] # GP is slow only run for 1k!
