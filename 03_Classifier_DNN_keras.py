...
def DNN_estimate(x_train_nn_all, choice_train_nn_all, cv, base, output_file_path, DNN_para, Re_run, computer_info,verbose_or_not, training_epochs,
        ...
        for Dependent_var in Dependent_var_list:
            ...
            for dnn_struc in dnn_struc_list:
                ...
                for sample_size in sample_size_list:
                    ...
                    DNN_estimate(x_train_nn_all, choice_train_nn_all, num_cross_validation, base, output_file_path, DNN_para, Re_run, computer_info, verbose_or_not,training_epochs,
